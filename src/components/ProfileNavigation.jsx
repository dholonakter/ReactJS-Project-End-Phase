    ...
    <div>
      <div className="bg-light">
        <nav className="navbar navbar-expand-lg navbar-light bg-light container ">
          <Link id="home_nav" className="navbar-brand font-weight-bold" to="/home">
            Profile
          </Link>
          ...
          <ul className="navbar-nav ml-auto">
            <li className={`nav-item  ${props.location.pathname === "/profile" ? "active" : ""}`} >
              <Link id="personal_nav" className="nav-link font-weight-bold" to="/profile">
               Personal Information
              </Link>
            </li>
            <li className={`nav-item  ${props.location.pathname === "/userproduct" ? "active" : ""}`} >
              <Link className="nav-link font-weight-bold" to="/userproducts">
                My Products
              </Link>
            </li>
            <li className={`nav-item  ${props.location.pathname === "/userhistory" ? "active" : ""}`} >
