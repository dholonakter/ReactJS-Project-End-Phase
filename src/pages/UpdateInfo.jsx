      ...
      <div className="container">
        <div className="row align-items-center my-5">
          ...
          <div className="col-lg-8">
            <div className="row">
              ...
              <div className="col-lg-10">
                <center>
                  <Typography className="font-weight-light" variant="h3">
                    Update Information
                  </Typography>
                </center>
              </div>
            ...
            <form>
              ...
              <div className="row">
                <Typography
                  className="font-weight-light col-lg-10"
                  variant="h5"
                >
                  Change Password
                </Typography>
          ...
          <div id="id01" class="modal">
            <span onClick={closewindow} class="close" title="Close Modal">
              &times;
            </span>
